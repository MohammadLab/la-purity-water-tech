      ...
      <div className="relative aspect-[4/3] overflow-hidden rounded-t-2xl bg-gray-50">
        {img ? (
          <Image
            ...
            width={800}
            height={600}
            // Keep the image sharp on hover: no backdrop blur, small GPU-accelerated scale.
            className="h-full w-full object-cover transition-transform duration-300 transform-gpu
        ...
        {/* REMOVED the glass blur overlay */}
